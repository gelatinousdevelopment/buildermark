...
- [ ] In the @web/server/internal/agent/claude implementation, figure out how to find claude's title for each session/conversation, then add that to the conversations table in the database (also add a string column for it)
