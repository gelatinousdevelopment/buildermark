...
- [ ] Add plugin: gemini
- [ ] Add plugin: opencode
- [ ] Add UI to rate conversations, inserting the rating after any user turn (prompt) in the conversations detail page @web/frontend/src/routes/dashboard/conversations/[id] file. You should be able to reuse the existing POST rating API endpoint, although you won't have the model feedback part, of course.
