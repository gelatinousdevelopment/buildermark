...
- [ ] Reorganize the conversations detail page in @web/frontend to interleave the ratings in with the turns instead of having them separate. Replace the user turns that start with /zrate with the matching rating object, of course. Also, sort this list by oldest first.
